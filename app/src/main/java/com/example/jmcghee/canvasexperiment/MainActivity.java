package com.example.jmcghee.canvasexperiment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPaintText.setColor(mColorPrimaryDark);
    ...
    private void initColors() {
        ...
        mColorPrimaryDark = ResourcesCompat.getColor(getResources(), R.color.colorPrimaryDark, null);
    }
}
